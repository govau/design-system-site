<div class="au-body au-body--dark example-form-item">
  <label class="example-label au-label" for="text-input-sm-dark">Postcode</label>
...
<div class="au-body au-body--dark example-form-item">
  <label class="example-label au-label" for="text-input-md-dark">Mobile</label>
...
<div class="au-body au-body--dark example-form-item">
  <label class="example-label au-label" for="text-input-lg-dark">Address</label>
